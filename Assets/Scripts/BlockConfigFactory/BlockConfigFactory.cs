...
public static class BlockConfigFactory
{
    ...
    private static readonly Dictionary<BlockType, BlockConfig> Configurations = new Dictionary<BlockType, BlockConfig>
    {
        ...
        { BlockType.Blue, new BlockConfig { hitsToDestroy = 1, pointsPerHit = 100 } },
        { BlockType.Cian, new BlockConfig { hitsToDestroy = 1, pointsPerHit = 125 } },
        { BlockType.Green, new BlockConfig { hitsToDestroy = 1, pointsPerHit = 150 } },
        { BlockType.Red, new BlockConfig { hitsToDestroy = 1, pointsPerHit = 200 } },
        { BlockType.Orange, new BlockConfig { hitsToDestroy = 1, pointsPerHit = 250 } }
    };
